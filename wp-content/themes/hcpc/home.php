<?php get_header(); ?>
	...
	<section id="index-main" style="background:url(<?php echo $indexUrl?>) no-repeat;">
		...
		<div id="qq">
			...
			<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=100145105&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:100145105:47" alt="点击这里给我发消息" title="点击这里给我发消息"></a>
		</div>
